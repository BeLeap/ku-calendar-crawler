...
buildRequest :: String -> String -> String -> IO Request
buildRequest year term category = do
  ...
  pure
    ...
    $ setRequestQueryString
      ...
      , ("srCategoryId1", Just $ encodeUtf8 $ T.pack category)
      ]
...
crawl (year, term, category) = do
  request <- buildRequest year term category
